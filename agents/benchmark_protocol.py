...
KNOWN_BENCHMARK_PROTOCOLS: dict[str, dict[str, Any]] = {
    ...
    "spider": {
        ...
        "aliases": ("spider", "xlangai/spider"),
        "hf_dataset": "",
        "config": "",
        "official_split": "dev",
        "task_family": "text_to_sql",
        "primary_metric": "execution_accuracy",
        "allowed_secondary_metrics": ("exact_match", "test_suite_accuracy"),
        "answer_format": "SQL query",
        "minimum_repeats": 1,
        "requires_harness": True,
    ...
    "bird": {
        "canonical_name": "BIRD",
        "aliases": ("bird", "bird-bench"),
        "hf_dataset": "",
        "config": "",
        "official_split": "dev",
        "task_family": "text_to_sql",
        "primary_metric": "execution_accuracy",
        "allowed_secondary_metrics": ("valid_efficiency_score", "exact_match"),
        "answer_format": "SQL query",
        "minimum_repeats": 1,
        "requires_harness": True,
    ...
    "agentdojo": {
        ...
        "aliases": ("agentdojo", "agent dojo"),
        "hf_dataset": "",
        "config": "",
        "official_split": "benchmark",
        "task_family": "agent_tool_safety",
        "primary_metric": "attack_success_rate",
        "allowed_secondary_metrics": ("utility", "safe_utility", "false_refusal_rate"),
        "answer_format": "benchmark-defined tool/action trace",
        "minimum_repeats": 1,
        "requires_harness": True,
    ...
    "harmbench": {
        ...
        "aliases": ("harmbench", "harm bench"),
        "hf_dataset": "",
        "config": "",
        "official_split": "benchmark",
        "task_family": "safety_refusal_evaluation",
        "primary_metric": "attack_success_rate",
        "allowed_secondary_metrics": ("refusal_precision", "refusal_recall", "false_refusal_rate"),
        "answer_format": "benchmark-defined safe/unsafe behavior decision",
        "minimum_repeats": 1,
        "requires_harness": True,
        "official_url": "https://github.com/centerforaisafety/HarmBench",
    },
    "advbench": {
        "canonical_name": "AdvBench",
        "aliases": ("advbench", "adv bench"),
        "hf_dataset": "",
        "config": "",
        "official_split": "benchmark",
        "task_family": "jailbreak_refusal_evaluation",
        "primary_metric": "attack_success_rate",
        "allowed_secondary_metrics": ("refusal_rate", "false_refusal_rate"),
        "answer_format": "benchmark-defined harmful request/refusal outcome",
        "minimum_repeats": 1,
        "requires_harness": True,
    ...
    "longmemeval": {
        ...
        "aliases": ("longmemeval", "longmem eval", "xiaowu0162/longmemeval-cleaned"),
        "hf_dataset": "xiaowu0162/longmemeval-cleaned",
        "config": "default",
        "official_split": "longmemeval_oracle",
        "task_family": "long_context_memory",
        "primary_metric": "f1",
        "allowed_secondary_metrics": ("exact_match", "cost_adjusted_accuracy", "latency", "tokens"),
        "answer_format": "short answer with evidence/memory context",
        "minimum_repeats": 1,
        "requires_harness": True,
        "official_url": "https://huggingface.co/datasets/xiaowu0162/longmemeval-cleaned",
    },
    "longbench": {
        "canonical_name": "LongBench",
        "aliases": ("longbench", "long bench"),
        "hf_dataset": "",
        "config": "",
        "official_split": "test",
        "task_family": "long_context_qa",
        "primary_metric": "score",
        "allowed_secondary_metrics": ("f1", "exact_match", "latency", "tokens"),
        "answer_format": "benchmark-defined long-context answer",
        "minimum_repeats": 1,
        "requires_harness": True,
        "official_url": "https://github.com/THUDM/LongBench",
    },
    "clevrer": {
        "canonical_name": "CLEVRER",
        "aliases": ("clevrer", "zechen-nlp/clevrer"),
        "hf_dataset": "zechen-nlp/clevrer",
        "config": "descriptive",
        "official_split": "validation",
        "task_family": "visual_physical_reasoning",
        "primary_metric": "accuracy",
        "allowed_secondary_metrics": ("counterfactual_consistency", "spatial_relation_accuracy", "calibration_error"),
        "answer_format": "benchmark-defined video question answer",
        "minimum_repeats": 1,
        "requires_harness": True,
        "official_url": "http://clevrer.csail.mit.edu/",
    },
    "prm800k": {
        "canonical_name": "PRM800K",
        "aliases": ("prm800k", "openai/prm800k"),
        "hf_dataset": "",
        "config": "",
        "official_split": "test",
        "task_family": "process_reward_evaluation",
        "primary_metric": "step_correctness_accuracy",
        "allowed_secondary_metrics": ("process_reward_accuracy", "answer_accuracy", "calibration_error"),
        "answer_format": "step-level process-supervision label",
        "minimum_repeats": 1,
        "requires_harness": True,
        "official_url": "https://github.com/openai/prm800k",
    },
    "processbench": {
        "canonical_name": "ProcessBench",
        "aliases": ("processbench", "process bench", "qwen/processbench"),
        "hf_dataset": "Qwen/ProcessBench",
        "config": "",
        "official_split": "test",
        "task_family": "process_reward_evaluation",
        "primary_metric": "process_error_localization_accuracy",
        "allowed_secondary_metrics": ("step_correctness_accuracy", "answer_accuracy", "calibration_error"),
        "answer_format": "benchmark-defined erroneous step/localization label",
        "minimum_repeats": 1,
        "requires_harness": True,
        "official_url": "https://huggingface.co/datasets/Qwen/ProcessBench",
    },
    "t2icompbench": {
        "canonical_name": "T2I-CompBench",
        "aliases": ("t2i-compbench", "t2i compbench", "t2icompbench"),
        "hf_dataset": "",
        "config": "",
        "official_split": "benchmark",
        "task_family": "text_to_image_compositionality",
        "primary_metric": "compositional_score",
        "allowed_secondary_metrics": ("attribute_binding", "object_relationship", "complex_composition"),
        "answer_format": "generated image scored by benchmark protocol",
        "minimum_repeats": 3,
        "requires_harness": True,
...
def resolve_benchmark_protocol(
    ...
    *,
    ...
    for row in _dataset_rows(plan):
        ...
        requires_harness = bool(row.get("requires_harness") or known.get("requires_harness"))
        harness_ready = bool(
            row.get("harness_materialized")
        ...
        if requires_harness and not harness_ready:
            blockers.append(
                f"{raw_name or 'dataset'} requires a dedicated benchmark harness/materialization before formal execution."
            )
        ...
        dataset_protocols.append(
            {
                ...
                "official_url": _text(row.get("official_url") or row.get("source_url") or known.get("official_url")),
