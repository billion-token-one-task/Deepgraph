...
EXPERIMENT_FIGURE_RULES = {
    ...
    "style_reference_contract": [
        ...
        "Use low-saturation fills, light grid lines, thin dark edges, shared legends, and concise panel titles.",
        "Do not reserve a large bottom gutter for legends. For wide 1x4 figures, prefer per-panel tick labels, compact in-panel legends, or a tiny top legend so the caption sits close to the plotted area.",
    ...
    "latex_spacing": {
        ...
        "post_graphics_vspace_for_plots": "-0.45em",
        "rule": "Experiment figures should not leave a visually large gap between image content and caption.",
    },
