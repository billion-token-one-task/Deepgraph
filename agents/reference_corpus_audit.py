...
def audit_against_reference_corpus(
    *,
    ...
    if generated["bibliography_entry_count"] < 30:
        issues.append({"severity": "medium", "issue": "Bibliography is sparse relative to the full-paper reference policy (30 entries, aiming for roughly 50 when available)."})
