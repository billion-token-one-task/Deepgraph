...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "agenda.all": "All agendas",
      "decisions.title": "Adjudicated findings",
      "decisions.subtitle": "Every verdict the evidence ladder has recorded, with the audit record it rests on.",
      "decisions.empty": "No adjudicated findings in this scope yet.",
      "decisions.runLabel": "experiment run",
      "decisions.evaluator": "evaluator",
      "decisions.baseline": "baseline",
      "decisions.best": "best",
      "decisions.effect": "effect",
      "decisions.openPaper": "Open manuscript",
    ...
    zh: {
      ...
      "agenda.all": "全部 agenda",
      "decisions.title": "已判定发现",
      "decisions.subtitle": "证据阶梯记录下来的全部裁决,以及它所依据的审计记录。",
      "decisions.empty": "当前范围内还没有已判定的发现。",
      "decisions.runLabel": "实验运行",
      "decisions.evaluator": "评测器",
      "decisions.baseline": "基线",
      "decisions.best": "最佳",
      "decisions.effect": "效应",
      "decisions.openPaper": "打开论文稿",
