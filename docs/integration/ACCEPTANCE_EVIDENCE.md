...
| 8 | pilot/GPU/full benchmark require grant | proposal/ingestion/post-agenda LLM roles and CPU/local/SSH durable compute admission are grant-scoped | partial; Colab durable runtime and all isolated execution remain |
...
| 12 | restart resumes without duplicate | durable claim-before-submit, live-job reuse, unknown-outcome quarantine and reconciliation-before-auto-research startup exist | isolated crash evidence missing |
