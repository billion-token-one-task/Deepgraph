...
LLM_EXTRA_PROVIDERS_JSON = _env_str("DEEPGRAPH_LLM_EXTRA_PROVIDERS_JSON", "")
...
PIPELINE_MAX_RETRYABLE_FAILURES = _env_int("DEEPGRAPH_PIPELINE_MAX_RETRYABLE_FAILURES", 12)
...
EXPERIMENT_PLATEAU_PATIENCE = _env_int("SCIFORGE_PLATEAU_PATIENCE", 12)
...
EXPERIMENT_REQUIRE_REAL_BENCHMARK = _env_bool("DEEPGRAPH_REQUIRE_REAL_BENCHMARK", True)
EXPERIMENT_ALLOW_SYNTHETIC_FALLBACK = _env_bool("DEEPGRAPH_ALLOW_SYNTHETIC_FALLBACK", False)
EXPERIMENT_REAL_LLM_MODEL = _env_str("DEEPGRAPH_REAL_LLM_MODEL", "Qwen/Qwen2.5-7B-Instruct")
EXPERIMENT_REAL_BENCHMARK_DATASET = _env_str("DEEPGRAPH_REAL_BENCHMARK_DATASET", "openai/gsm8k")
EXPERIMENT_REAL_BENCHMARK_DATASET_CONFIG = _env_str("DEEPGRAPH_REAL_BENCHMARK_DATASET_CONFIG", "main")
EXPERIMENT_REAL_BENCHMARK_MAX_EXAMPLES = _env_int("DEEPGRAPH_REAL_BENCHMARK_MAX_EXAMPLES", 64)
EXPERIMENT_REAL_BENCHMARK_SEEDS = _env_int("DEEPGRAPH_REAL_BENCHMARK_SEEDS", 3)
EXPERIMENT_REAL_BENCHMARK_TIME_BUDGET = _env_int("DEEPGRAPH_REAL_BENCHMARK_TIME_BUDGET", 3600)
...
REPRODUCTION_REPAIR_MAX_ROUNDS = _env_int("DEEPGRAPH_REPRODUCTION_REPAIR_MAX_ROUNDS", 8)
ALLOW_SMOKE_EXPERIMENT_VALIDATION = _env_bool("DEEPGRAPH_ALLOW_SMOKE_EXPERIMENT_VALIDATION", False)
...
GPU_STALE_RECOVERY_POLL_SECONDS = _env_int("DEEPGRAPH_GPU_STALE_RECOVERY_POLL_SECONDS", 120)
...
MANUSCRIPT_LATEX_TEMPLATE = _env_str("DEEPGRAPH_MANUSCRIPT_LATEX_TEMPLATE", "iclr2026")
SUBMISSION_BUNDLE_FORMATS = _split_csv(os.getenv("DEEPGRAPH_SUBMISSION_BUNDLE_FORMATS")) or ["conference"]
...
REFERENCE_PDF_CORPUS_DIR = Path(
    _env_str("DEEPGRAPH_REFERENCE_PDF_CORPUS_DIR", str(PROJECT_ROOT.parent.parent / "workspace" / "pdfs"))
)
ICLR2026_TEMPLATE_DIR = Path(
    _env_str("DEEPGRAPH_ICLR2026_TEMPLATE_DIR", str(PROJECT_ROOT / "third_party" / "iclr2026" / "iclr2026"))
)
...
AUTO_PIPELINE_ENABLED = _env_bool("DEEPGRAPH_AUTO_PIPELINE_ENABLED", False)
AUTO_PIPELINE_BATCH_SIZE = _env_int("DEEPGRAPH_AUTO_PIPELINE_BATCH_SIZE", 100)
AUTO_PIPELINE_INTERVAL_SECONDS = _env_int("DEEPGRAPH_AUTO_PIPELINE_INTERVAL_SECONDS", 120)
AUTO_PIPELINE_START_DELAY_SECONDS = _env_int("DEEPGRAPH_AUTO_PIPELINE_START_DELAY_SECONDS", 10)
...
REQUIRE_EVOSCIENTIST_FOR_EXPERIMENTS = _env_bool("DEEPGRAPH_REQUIRE_EVOSCIENTIST_FOR_EXPERIMENTS", False)
